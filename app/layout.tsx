                    ...
                    <footer className="bg-slate-900 text-white mt-auto">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
                            <Link href="/" className="inline-flex items-center gap-2 sm:gap-2.5">
                                <span className="flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-primary-500/20 text-primary-400">
                                    <TerminalSquare className="w-4 h-4 sm:w-5 sm:h-5" />
                                </span>
                                <span className="font-bold text-sm sm:text-lg tracking-tight">PORTAIL API</span>
                            </Link>
