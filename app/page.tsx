...
export default function HomePage() {
    return (
        <div className="w-full">
            ...
            <section className="relative z-10 -mt-0 w-full bg-slate-800">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                        {services.map((service, i) => {
                            ...
                            <motion.div
                                ...
                                className="group"
                            >
                                <div className="flex flex-col h-full p-6 rounded-card border border-slate-200/80 bg-white hover:shadow-card-hover hover:border-slate-200 transition-all duration-200">
            ...
            <section id="temoignages" className="border-t border-slate-200/60">
                <TestimonialsSection
                    label="Témoignage"
